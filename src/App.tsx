...
import CoinsCount from "./pages/coins/CoinsCount";
import GetCoins from "./pages/coins/GetCoins";
import CoinsVerifiedCount from "./pages/coins/CoinsVerifiedCount";
import CoinsWithMarketCapCount from "./pages/coins/CoinsWithMarketCapCount";
import CoinsDashboard from "./pages/coins/CoinsDashboard";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/coins/get-coins" element={<GetCoins />} />
        <Route path="/coins/coins-with-market-cap-count" element={<CoinsWithMarketCapCount />} />
