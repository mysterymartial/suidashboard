...
export default function Validators() {
  ...
  const { validatorsData, error } = useWalrusValidators(page);
  ...
  if (!validatorsData?.content) return <Text>No validators found.</Text>;
  ...
  return (
    <main className="p-6 space-y-6">
      <CardComponent>
        ...
        {/* scroll wrapper (fix) */}
        <Table.Root className="min-w-[1400px] border border-[#e8e8e8] rounded-[10px]">
          <Table.Header>
            <Table.Row>
              ...
              <Table.ColumnHeaderCell>
                PreActive Withdrawals
              </Table.ColumnHeaderCell>
              <Table.ColumnHeaderCell>
                Pending Share Withdrawals
              </Table.ColumnHeaderCell>
                ...
                <Table.Cell>
                  <Flex gap="2" align="center">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#292929]">
