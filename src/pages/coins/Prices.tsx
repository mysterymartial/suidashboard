        ...
        <CardComponent className="p-6">
                    ...
                    <Table.Row key={coin.coin || index}>
                      <Table.Cell>
                        <Flex align="center" gap="3">
                          ...
                          <div>
                            <Text weight="medium">
                              {coin.coinMetadata?.name || "Unknown Token"}
                            </Text>
                      ...
                      <Table.Cell>
                        <Text>
                          $
                          {formatNumber(
                            coin.buyVolumeStats1d?.volumeUsd +
                              coin.sellVolumeStats1d?.volumeUsd || 0,
                          )}
                        </Text>
                      </Table.Cell>
                      <Table.Cell>
          ...
          {!loading && trendingCoins.length === 0 && (
            <Flex justify="center" align="center" className="py-8">
              <Text className="text-[#292929]">No trending coins data available</Text>
            </Flex>
          )}
        </CardComponent>
      </main>
