...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.core = new core_1.default(this.spec, 'blockberry/1.0.0 (api/6.1.3)');
    }
    /**
     ...
     * @summary getAccounts
     */
    SDK.prototype.getAccounts_1 = function (metadata) {
     ...
     */
    SDK.prototype.getAccountByHash = function (metadata) {
     ...
     * @summary getBlobs
     */
    SDK.prototype.getBlobs = function (metadata) {
     ...
     */
    SDK.prototype.getAccountBlobs = function (metadata) {
     ...
     * @summary getBlobById
     */
    SDK.prototype.getBlobById = function (metadata) {
     ...
     */
    SDK.prototype.getValidators = function (metadata) {
     ...
     */
    SDK.prototype.getValidatorByAddress = function (metadata) {
     ...
     */
    SDK.prototype.getDelegatorsByValidator = function (metadata) {
     ...
     */
    SDK.prototype.getDelegationsByValidator = function (metadata) {
     ...
     */
    SDK.prototype.getAvgBlobSizeChart = function (metadata) {
     ...
     */
    SDK.prototype.getAccountsCountChart = function (metadata) {
     ...
     */
    SDK.prototype.getBlobsCountChart = function (metadata) {
